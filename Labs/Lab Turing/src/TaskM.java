...
public class TaskM {
    ...
    public void solve() throws IOException {
        ...
        out.println("TO_RIGHT _ _ _ -> WRITE_BACK_FIRST _ < _ < _ <");
        ...
        out.println("TO_LEFT 0 _ _ -> WRITE_BACK_FIRST _ < _ < _ <");
        ...
        out.println("TO_LEFT 1 _ _ -> WRITE_BACK_FIRST _ < _ < _ <");
        ...
        out.println("TO_RIGHT | _ _ -> WRITE_BACK_FIRST | < _ < _ <");
        out.println("WRITE_BACK_FIRST 1 0 1 -> WRITE_BACK_FIRST 0 < _ < 1 ^");
        out.println("WRITE_BACK_FIRST 1 0 0 -> WRITE_BACK_FIRST 0 < _ < 0 ^");
        out.println("WRITE_BACK_FIRST 1 0 | -> WRITE_BACK_FIRST 0 < _ < | ^");
        out.println("WRITE_BACK_FIRST 1 0 _ -> WRITE_BACK_FIRST 0 < _ < _ ^");
        out.println("WRITE_BACK_FIRST 0 0 1 -> WRITE_BACK_FIRST 0 < _ < 1 ^");
        out.println("WRITE_BACK_FIRST 0 0 0 -> WRITE_BACK_FIRST 0 < _ < 0 ^");
        out.println("WRITE_BACK_FIRST 0 0 | -> WRITE_BACK_FIRST 0 < _ < | ^");
        out.println("WRITE_BACK_FIRST 0 0 _ -> WRITE_BACK_FIRST 0 < _ < _ ^");
        out.println("WRITE_BACK_FIRST | 0 1 -> WRITE_BACK_FIRST 0 < _ < 1 ^");
        out.println("WRITE_BACK_FIRST | 0 0 -> WRITE_BACK_FIRST 0 < _ < 0 ^");
        out.println("WRITE_BACK_FIRST | 0 | -> WRITE_BACK_FIRST 0 < _ < | ^");
        out.println("WRITE_BACK_FIRST | 0 _ -> WRITE_BACK_FIRST 0 < _ < _ ^");
        out.println("WRITE_BACK_FIRST _ 0 1 -> WRITE_BACK_FIRST 0 < _ < 1 ^");
        out.println("WRITE_BACK_FIRST _ 0 0 -> WRITE_BACK_FIRST 0 < _ < 0 ^");
        out.println("WRITE_BACK_FIRST _ 0 | -> WRITE_BACK_FIRST 0 < _ < | ^");
        out.println("WRITE_BACK_FIRST _ 0 _ -> WRITE_BACK_FIRST 0 < _ < _ ^");
        out.println("WRITE_BACK_FIRST 1 1 1 -> WRITE_BACK_FIRST 1 < _ < 1 ^");
        out.println("WRITE_BACK_FIRST 1 1 0 -> WRITE_BACK_FIRST 1 < _ < 0 ^");
        out.println("WRITE_BACK_FIRST 1 1 | -> WRITE_BACK_FIRST 1 < _ < | ^");
        out.println("WRITE_BACK_FIRST 1 1 _ -> WRITE_BACK_FIRST 1 < _ < _ ^");
        out.println("WRITE_BACK_FIRST 0 1 1 -> WRITE_BACK_FIRST 1 < _ < 1 ^");
        out.println("WRITE_BACK_FIRST 0 1 0 -> WRITE_BACK_FIRST 1 < _ < 0 ^");
        out.println("WRITE_BACK_FIRST 0 1 | -> WRITE_BACK_FIRST 1 < _ < | ^");
        out.println("WRITE_BACK_FIRST 0 1 _ -> WRITE_BACK_FIRST 1 < _ < _ ^");
        out.println("WRITE_BACK_FIRST | 1 1 -> WRITE_BACK_FIRST 1 < _ < 1 ^");
        out.println("WRITE_BACK_FIRST | 1 0 -> WRITE_BACK_FIRST 1 < _ < 0 ^");
        out.println("WRITE_BACK_FIRST | 1 | -> WRITE_BACK_FIRST 1 < _ < | ^");
        out.println("WRITE_BACK_FIRST | 1 _ -> WRITE_BACK_FIRST 1 < _ < _ ^");
        out.println("WRITE_BACK_FIRST _ 1 1 -> WRITE_BACK_FIRST 1 < _ < 1 ^");
        out.println("WRITE_BACK_FIRST _ 1 0 -> WRITE_BACK_FIRST 1 < _ < 0 ^");
        out.println("WRITE_BACK_FIRST _ 1 | -> WRITE_BACK_FIRST 1 < _ < | ^");
        out.println("WRITE_BACK_FIRST _ 1 _ -> WRITE_BACK_FIRST 1 < _ < _ ^");
        out.println("WRITE_BACK_FIRST 1 _ 1 -> WRITE_BACK_SECOND | < _ ^ 1 ^");
        out.println("WRITE_BACK_FIRST 1 _ 0 -> WRITE_BACK_SECOND | < _ ^ 0 ^");
        out.println("WRITE_BACK_FIRST 1 _ | -> WRITE_BACK_SECOND | < _ ^ | ^");
        out.println("WRITE_BACK_FIRST 1 _ _ -> WRITE_BACK_SECOND | < _ ^ _ ^");
        out.println("WRITE_BACK_FIRST 0 _ 1 -> WRITE_BACK_SECOND | < _ ^ 1 ^");
        out.println("WRITE_BACK_FIRST 0 _ 0 -> WRITE_BACK_SECOND | < _ ^ 0 ^");
        out.println("WRITE_BACK_FIRST 0 _ | -> WRITE_BACK_SECOND | < _ ^ | ^");
        out.println("WRITE_BACK_FIRST 0 _ _ -> WRITE_BACK_SECOND | < _ ^ _ ^");
        out.println("WRITE_BACK_FIRST | _ 1 -> WRITE_BACK_SECOND | < _ ^ 1 ^");
        out.println("WRITE_BACK_FIRST | _ 0 -> WRITE_BACK_SECOND | < _ ^ 0 ^");
        out.println("WRITE_BACK_FIRST | _ | -> WRITE_BACK_SECOND | < _ ^ | ^");
        out.println("WRITE_BACK_FIRST | _ _ -> WRITE_BACK_SECOND | < _ ^ _ ^");
        out.println("WRITE_BACK_FIRST _ _ 1 -> WRITE_BACK_SECOND | < _ ^ 1 ^");
        out.println("WRITE_BACK_FIRST _ _ 0 -> WRITE_BACK_SECOND | < _ ^ 0 ^");
        out.println("WRITE_BACK_FIRST _ _ | -> WRITE_BACK_SECOND | < _ ^ | ^");
        out.println("WRITE_BACK_FIRST _ _ _ -> WRITE_BACK_SECOND | < _ ^ _ ^");
        out.println("WRITE_BACK_SECOND 1 1 0 -> WRITE_BACK_SECOND 0 < 1 ^ _ <");
        out.println("WRITE_BACK_SECOND 1 0 0 -> WRITE_BACK_SECOND 0 < 0 ^ _ <");
        out.println("WRITE_BACK_SECOND 1 | 0 -> WRITE_BACK_SECOND 0 < | ^ _ <");
        out.println("WRITE_BACK_SECOND 1 _ 0 -> WRITE_BACK_SECOND 0 < _ ^ _ <");
        out.println("WRITE_BACK_SECOND 0 1 0 -> WRITE_BACK_SECOND 0 < 1 ^ _ <");
        out.println("WRITE_BACK_SECOND 0 0 0 -> WRITE_BACK_SECOND 0 < 0 ^ _ <");
        out.println("WRITE_BACK_SECOND 0 | 0 -> WRITE_BACK_SECOND 0 < | ^ _ <");
        out.println("WRITE_BACK_SECOND 0 _ 0 -> WRITE_BACK_SECOND 0 < _ ^ _ <");
        out.println("WRITE_BACK_SECOND | 1 0 -> WRITE_BACK_SECOND 0 < 1 ^ _ <");
        out.println("WRITE_BACK_SECOND | 0 0 -> WRITE_BACK_SECOND 0 < 0 ^ _ <");
        out.println("WRITE_BACK_SECOND | | 0 -> WRITE_BACK_SECOND 0 < | ^ _ <");
        out.println("WRITE_BACK_SECOND | _ 0 -> WRITE_BACK_SECOND 0 < _ ^ _ <");
        out.println("WRITE_BACK_SECOND _ 1 0 -> WRITE_BACK_SECOND 0 < 1 ^ _ <");
        out.println("WRITE_BACK_SECOND _ 0 0 -> WRITE_BACK_SECOND 0 < 0 ^ _ <");
        out.println("WRITE_BACK_SECOND _ | 0 -> WRITE_BACK_SECOND 0 < | ^ _ <");
        out.println("WRITE_BACK_SECOND _ _ 0 -> WRITE_BACK_SECOND 0 < _ ^ _ <");
        out.println("WRITE_BACK_SECOND 1 1 1 -> WRITE_BACK_SECOND 1 < 1 ^ _ <");
        out.println("WRITE_BACK_SECOND 1 0 1 -> WRITE_BACK_SECOND 1 < 0 ^ _ <");
        out.println("WRITE_BACK_SECOND 1 | 1 -> WRITE_BACK_SECOND 1 < | ^ _ <");
        out.println("WRITE_BACK_SECOND 1 _ 1 -> WRITE_BACK_SECOND 1 < _ ^ _ <");
        out.println("WRITE_BACK_SECOND 0 1 1 -> WRITE_BACK_SECOND 1 < 1 ^ _ <");
        out.println("WRITE_BACK_SECOND 0 0 1 -> WRITE_BACK_SECOND 1 < 0 ^ _ <");
        out.println("WRITE_BACK_SECOND 0 | 1 -> WRITE_BACK_SECOND 1 < | ^ _ <");
        out.println("WRITE_BACK_SECOND 0 _ 1 -> WRITE_BACK_SECOND 1 < _ ^ _ <");
        out.println("WRITE_BACK_SECOND | 1 1 -> WRITE_BACK_SECOND 1 < 1 ^ _ <");
        out.println("WRITE_BACK_SECOND | 0 1 -> WRITE_BACK_SECOND 1 < 0 ^ _ <");
        out.println("WRITE_BACK_SECOND | | 1 -> WRITE_BACK_SECOND 1 < | ^ _ <");
        out.println("WRITE_BACK_SECOND | _ 1 -> WRITE_BACK_SECOND 1 < _ ^ _ <");
        out.println("WRITE_BACK_SECOND _ 1 1 -> WRITE_BACK_SECOND 1 < 1 ^ _ <");
        out.println("WRITE_BACK_SECOND _ 0 1 -> WRITE_BACK_SECOND 1 < 0 ^ _ <");
        out.println("WRITE_BACK_SECOND _ | 1 -> WRITE_BACK_SECOND 1 < | ^ _ <");
        out.println("WRITE_BACK_SECOND _ _ 1 -> WRITE_BACK_SECOND 1 < _ ^ _ <");
        out.println("WRITE_BACK_SECOND 1 1 _ -> GO_LEFT_ARR 1 ^ 1 ^ _ ^");
        out.println("WRITE_BACK_SECOND 1 0 _ -> GO_LEFT_ARR 1 ^ 0 ^ _ ^");
        out.println("WRITE_BACK_SECOND 1 | _ -> GO_LEFT_ARR 1 ^ | ^ _ ^");
        out.println("WRITE_BACK_SECOND 1 _ _ -> GO_LEFT_ARR 1 ^ _ ^ _ ^");
        out.println("WRITE_BACK_SECOND 0 1 _ -> GO_LEFT_ARR 0 ^ 1 ^ _ ^");
        out.println("WRITE_BACK_SECOND 0 0 _ -> GO_LEFT_ARR 0 ^ 0 ^ _ ^");
        out.println("WRITE_BACK_SECOND 0 | _ -> GO_LEFT_ARR 0 ^ | ^ _ ^");
        out.println("WRITE_BACK_SECOND 0 _ _ -> GO_LEFT_ARR 0 ^ _ ^ _ ^");
        out.println("WRITE_BACK_SECOND | 1 _ -> GO_LEFT_ARR | ^ 1 ^ _ ^");
        out.println("WRITE_BACK_SECOND | 0 _ -> GO_LEFT_ARR | ^ 0 ^ _ ^");
        out.println("WRITE_BACK_SECOND | | _ -> GO_LEFT_ARR | ^ | ^ _ ^");
        out.println("WRITE_BACK_SECOND | _ _ -> GO_LEFT_ARR | ^ _ ^ _ ^");
        out.println("WRITE_BACK_SECOND _ 1 _ -> GO_LEFT_ARR _ ^ 1 ^ _ ^");
        out.println("WRITE_BACK_SECOND _ 0 _ -> GO_LEFT_ARR _ ^ 0 ^ _ ^");
        out.println("WRITE_BACK_SECOND _ | _ -> GO_LEFT_ARR _ ^ | ^ _ ^");
        out.println("WRITE_BACK_SECOND _ _ _ -> GO_LEFT_ARR _ ^ _ ^ _ ^");
